...
resource "aws_security_group" "matt-kube-mutual-sg" {
  name = "kube-mutual-sec-group-for-matt-1"
}

resource "aws_security_group" "matt-kube-worker-sg" {
  name = "kube-worker-sec-group-for-matt-1"
  ingress {
    protocol = "tcp"
    from_port = 10250
    to_port = 10250
...
resource "aws_security_group" "matt-kube-master-sg" {
  name = "kube-master-sec-group-for-matt-1"
...
resource "aws_instance" "kube-master" {
    ...
    key_name = "mattkey"
    subnet_id = "subnet-0d91b5b91f62bb8e8"  # select own subnet_id of us-east-1a
